...
public class TraduceMano {//Sin Terminar
    ...
    public String tabla2texto(Rango rango){
        String sol = "";
        ...
        for(int i = 0; i < parejas.size(); i++){
            if(seguidos == 0){//empiezas una posible secuencia de continuas
                ...
                else sol += parejas.get(i-1).toString() + ',';
                i--;
                seguidos = 0;
            }
            if(parejas.get(i).getCarta1()== 14) sol += parejas.get(baja).toString() + '+';//Estaria ya al final y es la unica posibilidad del +
        }
        //reseteamos parametros
        baja = 0;
        seguidos = 0;
        int pilar = offSuited.get(0).getCarta1();
        sol += '\n';
        for(int i = 0; i < offSuited.size(); i++){
            if(seguidos == 0){
                ...
                if(pilar == offSuited.get(i).getCarta2() + 1){//Tope para el +
                   ...
                   else sol += offSuited.get(i-1).toString() + ',';
                   i--;
                   seguidos = 0;
                }               
        ...
        for(int i = 0; i < suited.size(); i++){
            if(seguidos == 0){
                ...
                if(pilar == suited.get(i).getCarta2() + 1){//Tope para el +
                   ...
                   else sol += suited.get(i-1).toString() + ',';
                   i--;
                   seguidos = 0;
                }               
            }else{//Carta mayor no igual
